...
local WhitelistUsuarios = {
    ["BITMELKING"]=true, ["Metalix_24"]=true, ["periquitoRolox"]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true, ["  "]=true
} 
...
local UsuariosDEV = {"BITMELKING", "Metalix_24", "periquitoRolox"} 
...
local EmotesDatabase = {
    ...
    ["Sonic"] = {
        ...
        {Name = "Diaries", IsLoop = true, TraversalSpeed = 0, MusicId = "rbxassetid://76173803344707", AnimationId = "rbxassetid://92897830029002",
            OnUse = function(p1) if p1:FindFirstChild("Book") or p1:FindFirstChild("Feather") then return end if not script:FindFirstChild("Feather") or not script:FindFirstChild("Book") then return end local v1 = script.Feather:Clone(); v1.Parent = p1;
            v1:PivotTo(p1.HumanoidRootPart.CFrame * CFrame.Angles(0, 0, -1.5707963267948966)); v1.Root.CFrame = p1.HumanoidRootPart.CFrame * CFrame.Angles(0, 0, -1.5707963267948966); local Motor6D = Instance.new("Motor6D"); Motor6D.Name = v1.Feather.Name;
            Motor6D.Part0 = p1.HumanoidRootPart; Motor6D.Part1 = v1.Feather; Motor6D.C0 = p1.HumanoidRootPart.CFrame:toObjectSpace(v1.Feather.CFrame); Motor6D.Parent = v1.Feather; local v3 = script.Book:Clone(); v3.Parent = p1; v3:PivotTo(p1.HumanoidRootPart.CFrame);
            local Motor6D2 = Instance.new("Motor6D"); Motor6D2.Name = v3.PrimaryPart.Name; Motor6D2.Part0 = p1.HumanoidRootPart; Motor6D2.Part1 = v3.PrimaryPart; Motor6D2.C0 = p1.HumanoidRootPart.CFrame:toObjectSpace(v3.PrimaryPart.CFrame);
...
-- ==========================================
-- 1. SISTEMA DE CHASES INDIVIDUALES
-- ==========================================
local silentGroupGlobal = nil
local function manejarChases(exeName, valor)
    Chase_Estados[exeName] = valor
    for originalSound, data in pairs(chaseObjects) do
        if data.owner == exeName then
...
-- ==========================================
-- 2. BOTONES DE LA INTERFAZ - EXES
-- ==========================================
crearCategoria(SettingsFrame, "Exe's", colorRojo)

crearToggle(SettingsFrame, "musica 2011x (Default) {NO ACTIVAR si usas 2011x Feels}", false, colorRojo, function(valor)
    manejarChases("2011x_Default", valor)
end)
crearToggle(SettingsFrame, "musica 2011x (RETRO)", true, colorRojo, function(valor)
    manejarChases("2011x_Retro", valor)
end)
crearToggle(SettingsFrame, "musica 2011x (Miku)", true, colorRojo, function(valor)
    manejarChases("2011x_Miku", valor)
end)
crearToggle(SettingsFrame, "musica TailsDoll", true, colorRojo, function(valor) 
    manejarChases("TailsDoll", valor) 
end)
crearToggle(SettingsFrame, "musica Kolossos", true, colorRojo, function(valor) 
    manejarChases("Kolossos", valor) 
end)
crearToggle(SettingsFrame, "musica Fleetway", true, colorRojo, function(valor) 
    manejarChases("Fleetway", valor) 
end)

crearToggle(SettingsFrame, "Fleetway LMS (Baja Vida)", false, colorRojo, function(valor) 
    Fleetway_LMS_Activo = valor 
end)
...
if EsDesarrollador then 
    ...
    crearToggle(DevFrame, "Full Bright", false, colorDev, function(valor)          
        ...
        if isFullBright then 
            ...
            oldShadows = Lighting.GlobalShadows; oldAmbient = Lighting.Ambient                        
            Lighting.Brightness = 2;
            Lighting.GlobalShadows = false; Lighting.Ambient = Color3.fromRGB(255,255,255)                
        else                        
            Lighting.Brightness = oldBrightness or 1;
            Lighting.GlobalShadows = oldShadows or true; Lighting.Ambient = oldAmbient or Color3.fromRGB(128,128,128)                
        end        
    end)        
...
task.spawn(function()
    ...
    local function registrarIdOriginal(pathTable, url, filename, multiplicadorVolumen, exeOwner)
        ...
        if current:IsA("Sound") and current.SoundId ~= "" then
            ...
            current:SetAttribute("ExeOwner", exeOwner)
            soundMap[normalizeId(current.SoundId)] = {
                asset = customAsset, 
                mult = multiplicadorVolumen, 
                owner = exeOwner
            }
        end
    end
    ...
    registrarIdOriginal({"2011x", "miku", "Rage"}, "https://raw.githubusercontent.com/IceKnight125/OutcomeMemories1227/main/MikuRage.mp3", "MikuRage.mp3", 0.3, "2011x_Miku")
        ...
        registrarIdOriginal({"TailsDoll", "Default", "LastLifeChase"}, "https://raw.githubusercontent.com/imnotsense/LMS-Y-CHASES/main/tailsdoll-lastlife.mp3", "TailsDollLast.mp3", 0.5, "TailsDoll")
        registrarIdOriginal({"TailsDoll", "Default", "TerrorRadius"}, "https://raw.githubusercontent.com/imnotsense/LMS-Y-CHASES/main/terrorradiusTailsdoll.mp3", "TailsDollTerror.mp3", 3, "TailsDoll")

        -- Kolossos
        registrarIdOriginal({"Kolossos", "Default", "NormalChase"}, "https://raw.githubusercontent.com/imnotsense/LMS-Y-CHASES/main/Kolossos-normal.mp3", "KolossosNormal.mp3", 0.5, "Kolossos")
        registrarIdOriginal({"Kolossos", "Default", "LastLifeChase"}, "https://raw.githubusercontent.com/imnotsense/LMS-Y-CHASES/main/Kolossos-lastlife.mp3", "KolossosLast.mp3", 0.5, "Kolossos")
        registrarIdOriginal({"Kolossos", "Forest", "NormalChase"}, "https://raw.githubusercontent.com/imnotsense/LMS-Y-CHASES/main/ForestKolossos-normal.mp3", "KolossosVarNormal.mp3", 0.5, "Kolossos")
        registrarIdOriginal({"Kolossos", "Forest", "LastLifeChase"}, "https://raw.githubusercontent.com/imnotsense/LMS-Y-CHASES/main/ForestKolossos-lastlife.mp3", "KolossosVarLast.mp3", 0.5, "Kolossos")

        -- Fleetway
        registrarIdOriginal({"Fleetway", "Default", "NormalChase"}, "https://raw.githubusercontent.com/imnotsense/LMS-Y-CHASES/main/Fleetway-normal.mp3", "FleetwayNormal.mp3", 0.5, "Fleetway")
        registrarIdOriginal({"Fleetway", "Default", "LastLifeChase"}, "https://raw.githubusercontent.com/imnotsense/LMS-Y-CHASES/main/Fleetway-lastlife.mp3", "FleetwayLast.mp3", 0.5, "Fleetway")
    end)
    ...
    local function interceptarSonidoDelJuego(sound)
        ...
        local exeOwner = sound:GetAttribute("ExeOwner")
        ...
        local estadoActivo = true
        if exeOwner and Chase_Estados[exeOwner] ~= nil then
            estadoActivo = Chase_Estados[exeOwner]
        end

        local originalGroup = sound.SoundGroup
        if estadoActivo then 
            sound.SoundGroup = silentGroupGlobal or silentGroup 
        end
        ...
        customSound.Playing = (estadoActivo and sound.Playing)
        customSound.Volume = sound.Volume * (volumeMult or 1)

        local playingConn = sound:GetPropertyChangedSignal("Playing"):Connect(function()
            local actualActivo = true
            if exeOwner and Chase_Estados[exeOwner] ~= nil then actualActivo = Chase_Estados[exeOwner] end
            if actualActivo then customSound.Playing = sound.Playing else customSound.Playing = false end
        end)

        local volumeConn = sound:GetPropertyChangedSignal("Volume"):Connect(function()
            local actualActivo = true
            if exeOwner and Chase_Estados[exeOwner] ~= nil then actualActivo = Chase_Estados[exeOwner] end
            if actualActivo then customSound.Volume = sound.Volume * (volumeMult or 1) end
        end)
