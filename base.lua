...
crearToggle(SettingsFrame, "Chase Custom: Kolossos", true, colorRojo, function(valor) 
    manejarChases("Kolossos", valor) 
end)
crearToggle(SettingsFrame, "Chase Custom: Fleetway", true, colorRojo, function(valor) 
